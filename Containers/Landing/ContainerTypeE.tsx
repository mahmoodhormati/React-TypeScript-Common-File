...
const ContainerTypeE = ({ height, data }: LandigCoponentProps) => {
  ...
  return (
    <div id={`CMP${data.id}`} className='  rounded mt-4 mb-4' style={{ height: `${height}vh`, minHeight: '45vh' }}>
      ...
      <div className='   row p-2 ' style={{ height: `70%` }}>
        ...
        <div className=' col-4  '>
          <div id={`${data.componentDetails && data.componentDetails[1] ? `CMPD${data.componentDetails[1]?.id}` : ''}`} className=' defaultBakground defaultHeight2Col shadow myhoverStyle'
          ...
          <div id={`${data.componentDetails && data.componentDetails[2] ? `CMPD${data.componentDetails[2]?.id}` : ''}`} className=' defaultBakground mt-1 defaultHeight2Col shadow myhoverStyle'
        ...
        <div className=' col-4 '>
          <div id={`${data.componentDetails && data.componentDetails[3] ? `CMPD${data.componentDetails[3]?.id}` : ''}`} className=' defaultBakground defaultHeight2Col shadow myhoverStyle'
          ...
          <div id={`${data.componentDetails && data.componentDetails[4] ? `CMPD${data.componentDetails[4]?.id}` : ''}`} className=' defaultBakground mt-1 defaultHeight2Col shadow myhoverStyle'
