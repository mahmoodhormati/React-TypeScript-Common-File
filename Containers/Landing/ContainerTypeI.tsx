...
const ContainerTypeI = ({ height, data }: LandigCoponentProps) => {
    ...
    return (
        <div id={`CMP${data.id}`} className=' rounded mt-4 mb-4' style={{ height: `${height}vh`, minHeight: '45vh' }}>
            ...
            <div className='row p-2 ' style={{ height: `70%` }}>
                ...
                <div className="col-4   defaultHeight2Col ">
                ...
                <div className="col-4   defaultHeight2Col ">
                    <div id={`${data.componentDetails && data.componentDetails[1] ? `CMPD${data.componentDetails[1]?.id}` : ''}`} className="col-12 defaultBakground  defaultHeight1Col shadow myhoverStyle"
                ...
                <div className="col-4   defaultHeight2Col ">
                    <div id={`${data.componentDetails && data.componentDetails[2] ? `CMPD${data.componentDetails[2]?.id}` : ''}`} className="col-12 defaultBakground  defaultHeight1Col shadow myhoverStyle"
                ...
                <div className="col-4   defaultHeight2Col mt-1 ">
                    <div id={`${data.componentDetails && data.componentDetails[3] ? `CMPD${data.componentDetails[3]?.id}` : ''}`} className="col-12 defaultBakground  defaultHeight1Col myhoverStyle"
                ...
                <div className="col-4   defaultHeight2Col mt-1 ">
                    <div id={`${data.componentDetails && data.componentDetails[4] ? `CMPD${data.componentDetails[4]?.id}` : ''}`} className="col-12 defaultBakground  defaultHeight1Col myhoverStyle"
                ...
                <div className="col-4   defaultHeight2Col mt-1">
                    <div id={`${data.componentDetails && data.componentDetails[5] ? `CMPD${data.componentDetails[5]?.id}` : ''}`} className="col-12 defaultBakground  defaultHeight1Col myhoverStyle"
                        style={{ backgroundImage: images === true && data.componentDetails && data.componentDetails[5]?.attachments ? `url(${configure}/Global/GetFile/${data?.componentDetails[5]?.attachments[0]?.path}?w=${getelemntWidth(`CMPD${data.componentDetails[5]?.id}`)}&h=${getelemntHeight(`CMPD${data.componentDetails[5]?.id}`)})` : '' }}>
