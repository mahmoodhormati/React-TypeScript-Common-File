...
const ContainerTypeF = ({ height, data }: LandigCoponentProps) => {
          ...
          <p className='col-12'>{data.showDescription?data.description:''}</p>
            ...
            <div className=' row px-2 ' style={{ height: `70%` }}>
                ...
                <div className='col-8    defaultHeight1Col'>
                    ...
                    <div className="col-12 defaultHeight2Col d-flex  pt-2">
                        ...
                        <div className="col-4 ">
                            <div id={`${data.componentDetails && data.componentDetails[3] ? `CMPD${data.componentDetails[3]?.id}` : ''}`} className='col-11 mx-auto defaultBakground  defaultHeight1Col shadow myhoverStyle '
                        ...
                        <div className="col-4 ">
                            <div id={`${data.componentDetails && data.componentDetails[4] ? `CMPD${data.componentDetails[4]?.id}` : ''}`} className='col-12  px-2 defaultBakground  defaultHeight1Col shadow myhoverStyle '
