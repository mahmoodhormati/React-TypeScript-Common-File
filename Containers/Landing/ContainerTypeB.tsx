...
const ContainerTypeB = ({ height, data }:LandigCoponentProps) => {
    ...
    return (
      ...
      <div className=' row p-2  '  style={{ height: `70%` }}>
        ...
        <div className='   col-4 defaultHeight1Col  '>
          <div id={`${data?.componentDetails && data?.componentDetails[0]?`CMPD${data?.componentDetails[0]?.id}`:''}`}  className=' col-12 defaultBakground  defaultHeight2Col mb-2 shadow myhoverStyle' 
          ...
          <div id={`${data.componentDetails && data.componentDetails[1]?`CMPD${data.componentDetails[1]?.id}`:''}`}  className=' col-12 defaultBakground  defaultHeight2Col shadow myhoverStyle'
...
style={{ backgroundImage: images===true && data.componentDetails && data.componentDetails[2]?.attachments ? `url(${configure}/Global/GetFile/${ data?.componentDetails[2]?.attachments[0]?.path }?w=${getelemntWidth(`CMPD${data.componentDetails[2]?.id}`)}&h=${getelemntHeight(`CMPD${data.componentDetails[2]?.id}`)})` : '' }}>
        ...
        <div className='  col-4  defaultHeight1Col'>
          <div id={`${data.componentDetails && data.componentDetails[3]?`CMPD${data.componentDetails[3]?.id}`:''}`}  className='  col-12 defaultBakground  defaultHeight2Col mb-2 shadow myhoverStyle' 
 style={{ backgroundImage: images===true && data.componentDetails && data.componentDetails[3]?.attachments ? `url(${configure}/Global/GetFile/${ data?.componentDetails[3]?.attachments[0]?.path }?w=${getelemntWidth(`CMPD${data?.componentDetails[3]?.id}`)}&h=${getelemntHeight(`CMPD${data?.componentDetails[3]?.id}`)})` : '' }}>
          ...
          <div id={`${data.componentDetails && data.componentDetails[4]?`CMPD${data.componentDetails[4]?.id}`:''}`}  className='  col-12 defaultBakground defaultHeight2Col shadow myhoverStyle'  
