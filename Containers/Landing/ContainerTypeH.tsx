...
const ContainerTypeH = ({height,data}:LandigCoponentProps) => {
...
SetImages(true)
  ...
  return (
    ...
    <div  id={`${data.componentDetails && data.componentDetails[0]?`CMPD${data.componentDetails[0]?.id}`:''}`}   className=' defaultBakground col-12 defaultHeight1Col shadow myhoverStyle'
    ...
    <div className=' col-8  defaultHeight1Col'>
        ...
        <div  id={`${data.componentDetails && data.componentDetails[2]?`CMPD${data.componentDetails[2]?.id}`:''}`}   className='col-12 defaultBakground defaultHeight2Col mt-1 shadow myhoverStyle'
